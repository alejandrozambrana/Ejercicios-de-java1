...
public class Ejercicio4coordenadasEnArrayBiInt {
    public static void main(String[] args) {
      ...
      System.out.print("¿De que numero quieres saber la cordenada?: ");
        int num = Integer.parseInt(s.nextLine());
       
      FuncionesArrayBi.muestraArrayInt(FuncionesArrayBi.coordenadasEnArrayBiInt(a, num));
